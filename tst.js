...
if(error){
 ...
 let attck=document.querySelectorAll('.match-stats #allMapsAttackTeamOne .table-body >div.single-row.main-area-default');
...
K+=13;
h+=13;
T1_Total(T1name,name,rating,KdA,K_D,HSp);
  }
...
K1+=13;
h1+=13;
T2_Total(T2name,name1,rating1,KdA1,K_D1,HSp1);
}    
}
...
function T1_Total(T1name,name,rating,KdA,K_D,HSp){
...
function T2_Total(T2name,name1,rating1,KdA1,K_D1,HSp1){
